...
def main(file_path, report_name):
...
#           print l
            rcpts.append(l)
    rcpts.append('aleksey.yarkov@amrest.eu')
    rcpts.append('Otar.Ananov@amrest.eu')
    rcpts.append('Andrey.Tihonov@amrest.eu')
    rcpts.append('Kristina.Kazakova@amrest.eu')
    rcpts.append('Marisha.Smirnova@amrest.eu')
