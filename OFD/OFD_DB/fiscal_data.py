...
def main():
    ...
    r.main(test=True, storage_id='8710000100845840', reg_id='0000773723059118',
           date_from='2017-06-30T09:10:00', date_to='2017-06-30T11:20:00', send_to_sql=False, check_exist=True)
